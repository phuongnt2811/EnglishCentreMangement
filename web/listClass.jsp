<%-- 
    Document   : listClass
    Created on : Mar 2, 2022, 11:20:55 PM
    Author     : PHUONG
--%>
        ...
        <section class="home-section">
            ...
            <div class="home-content">
                <div class="home-table">
                    <div class="box">
                        <div class="title-box">List Class</div>
                        <div class="table-details">
                                ...
                                <tbody>
                                    <c:forEach items="${listClass}" var = "classes">
                                        <tr class="tr-hover">    
                                            ...
                                            <td>${classes.endate}</td>
                                            <td>${classes.teacherName}</td>
                                            <td>${classes.courseName}</td>
                                            <c:if test="${sessionScope.account.getRole() eq 'ADMIN'}">
                                                <td><a href="delete-class?id=${classes.id}">Delete</a>|<a href="update-class?id=${classes.id}">Update</a></td>
                                            </c:if>
                            ...
                            <c:if test="${sessionScope.account.getRole() eq 'ADMIN'}">                    
                <button type="button"> <a href="create-class">create new</a></button>
               </c:if>  
                        </div>
