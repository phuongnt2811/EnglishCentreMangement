                    ...
                    <div class="box">
                        ...
                        <div class="table-details">
                            <table>
                                ...
                                <tbody>
                                    <c:forEach items="${listLevels}" var = "level">
                                        <tr class="tr-hover">    
                                            <td>${level.id}</td>
                                            <td>${level.name}</td>
                                            <td>${level.signCode}</td>
                                            <c:if test="${sessionScope.account.getRole() eq 'ADMIN'}">
                                             <td><a href="delete-level?id=${level.id}">Delete</a>|<a href="update-level?id=${level.id}">Update</a></td>   
                                            </c:if>
                            ...
                            <button type="button"> <a href="create-level">create new</a></button>
                        </div>
