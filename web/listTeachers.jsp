                ...
                <div class="home-table">
                    <div class="box">
                        ...
                        <div class="table-details">
                                ...
                                <tbody>
                                    <c:forEach items="${listTeachers}" var = "teacher">
                                        <tr class="tr-hover">    
                                            ...
                                            <c:if test="${sessionScope.account.getRole() eq 'ADMIN'}">
                                              <td><a href="delete-teacher?id=${teacher.id}">Delete</a>|<a href="update-teacher?id=${teacher.id}">Update</a></td>  
                                            </c:if>
                            ...
                            <c:if test="${sessionScope.account.getRole() eq 'ADMIN'}">
                                <button type="button"> <a href="create-teacher">create new</a></button>
                            </c:if>
